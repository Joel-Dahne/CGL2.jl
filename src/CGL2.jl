...
include("linearization/Y_zero/Y.jl")
include("linearization/Y_zero/Y_float.jl")
include("linearization/Y_zero/equation.jl")

include("linearization/Y_infinity/parameters.jl")
include("linearization/Y_infinity/functions.jl")
include("linearization/Y_infinity/function_bounds.jl")
#include("linearization/Y_infinity/norm_bounds_constants.jl")
include("linearization/Y_infinity/norm_bounds.jl")
#include("linearization/Y_infinity/I_bounds.jl")
#include("linearization/Y_infinity/I.jl")

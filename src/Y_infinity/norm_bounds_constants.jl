...
function C_T_Y(
    ...
    return 2C_Y.E_12 * C_I_K_1(v, C_Y) + 2C_Y.P_12 * C_I_K_2(lambda, κ, v, λ, C_Y)
end
...
function C_Y_dλ_1(v::Arb, C_Y::FunctionBounds_Y_new)
    return 2C_Y.E_12 * exp(Arb(-1)) / v
end
...
function C_Y_dλ_2(
    ...
    return 2exp(Arb(-1)) / v *
           (C_Y.E_12_dλ * C_I_K_1(v, C_Y) + C_Y.P_12_dλ * C_I_K_2(lambda, κ, v, λ, C_Y)) *
           ξ₁^(v - 2)
end

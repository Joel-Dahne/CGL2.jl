...
function C_I_K_2_1(
    ...
    exponent = 2 / λ.σ - λ.d - 2real(lambda) / κ + v - 2
    @assert exponent < 0
    return C_Y.K_2_1 * C_Y.J_N / abs(exponent)
end
...
function C_I_K_2_2(
    ...
    exponent = 2 / λ.σ - λ.d - 2real(lambda) / κ + v - 2
    @assert exponent < 0
    return C_Y.K_2_2 * C_Y.J_N / abs(exponent)
end
...
function C_I_K_2_dλ_1_1(
    ...
    exponent = 2 / λ.σ - λ.d - 2real(lambda) / κ + v - 2
    @assert exponent < 0
    return C_Y.K_2_dλ_1 * C_Y.J_N * (abs(exponent) + inv(log(ξ₁))) / exponent^2
end
...
function C_I_K_2_dλ_1_2(
    ...
    exponent = 2 / σ - d - 2real(lambda) / κ + v - 2
    @assert exponent < 0
    return C_Y.K_2_dλ_2 * C_Y.J_N * (abs(exponent) + inv(log(ξ₁))) / exponent^2
end
...
function C_I_K_2_dλ_2_1(
    ...
    return C_I_K_2_1(lambda, κ, v, λ, C_Y)
end
...
function C_I_K_2_dλ_2_2(
    ...
    return C_I_K_2_2(lambda, κ, v, λ, C_Y)
end

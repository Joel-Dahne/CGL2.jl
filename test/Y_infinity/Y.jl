@testset "Y_infinity" begin
    ...
    res = CGL2.Y_infinity(c, lambda, γ₁, γ₂, κ, ϵ, ξ₁, λ)

    # Compare with Float64 version
    resF64 = CGL2.Y_infinity(cF64, lambdaF64, γ₁F64, γ₂F64, κF64, ϵF64, ξ₁F64, λF64)
    @test ComplexF64.(res) ≈ resF64 rtol = 1e-13

    res_J = CGL2.Y_infinity_derivative(c, lambda, γ₁, γ₂, κ, ϵ, ξ₁, λ)

    # Compare with Float64 version
    resF64_J =
        CGL2.Y_infinity_derivative(cF64, lambdaF64, γ₁F64, γ₂F64, κF64, ϵF64, ξ₁F64, λF64)
    ...
    @test ComplexF64.(res_J) ≈ resF64_J_fdm rtol = 1e-12
end

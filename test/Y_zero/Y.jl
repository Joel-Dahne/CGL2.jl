@testset "Y_zero" begin
    ...
    # Currently handling of Q_hat is not implemented in CAPD version.
    #For now we test with a zero Q_hat.
    #resF64 = CGL2.Y_zero(xF64, lambdaF64, νF64, κF64, ϵF64, ξ₁F64, λF64)
    resF64 = CGL2.Y_zero(xF64, lambdaF64, κF64, ϵF64, ξ₁F64, _ -> (0, 0), λF64)
    @test res ≈ resF64 rtol = 1e-10
    ...
    resF64_J = CGL2.Y_zero_jacobian(xF64, lambdaF64, κF64, ϵF64, ξ₁F64, _ -> (0, 0), λF64)
    @test ComplexF64.(res_J) ≈ resF64_J rtol = 1e-12
